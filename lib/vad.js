...
var acceptedSampleRates = [8000,16000,32000,48000];
...
VAD.prototype.processAudio = function(samples, samplerate, callback) {
    ...
    if(acceptedSampleRates.indexOf(samplerate) === -1){
      throw new Error('Only valid sample rates are '+acceptedSampleRates)
    }
