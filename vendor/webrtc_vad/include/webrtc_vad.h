...
// Creates an instance to the VAD structure from user provided memory.
// Returns the required memory size if mem is NULL or size is too small
// Otherwise returns zero on success and <0 on error 
int WebRtcVad_CreateUser(void* mem, size_t size);
...
// - fs           [i]   : Sampling frequency (Hz): 8000, 16000, 32000, or 48000
